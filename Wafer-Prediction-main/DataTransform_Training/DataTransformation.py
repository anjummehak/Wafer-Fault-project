...
class DataTransform:
    """
    This class is responsible for transforming the Good Raw Training Data before loading it into the database.

    Attributes:
        good_data_path (str): Path to the directory containing validated good raw data files.
        logger (App_Logger): Logger instance for logging messages.
    """

    def __init__(self):
        self.good_data_path = Path("Training_Raw_files_validated/Good_Raw")
